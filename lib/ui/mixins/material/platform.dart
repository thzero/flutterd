...
mixin MaterialPlatformMixin on PlatformMixin {
  @override
  Widget constructButton(BuildContext context, VoidCallback? onPressed, String title) {
  ...
  @override
  Widget constructButtonIcon(BuildContext context, VoidCallback? onPressed, String iconType) {
  ...
  @override
  Widget constructButtonTap(BuildContext context, TapDebouncerFunc? onTap, String title, {int? cooldown = 500}) {
    return TapDebouncer(
        cooldown: cooldown != null ? const Duration(milliseconds: 500) : null,
        onTap: onTap,
  ...
  @override
  Widget constructButtonTapIcon(BuildContext context, TapDebouncerFunc? onPressed, String iconType) {
    IconData icon = determineIcon(iconType);
  ...
  @override
  StatefulWidget constructScaffold(BuildContext context, Widget body, String title, {Widget? bottomNavigationBar, List<Widget>? actions}) {
    return Scaffold(resizeToAvoidBottomInset: false, appBar: AppBar(title: Text(title), actions: actions), body: body, bottomNavigationBar: bottomNavigationBar);
  }
